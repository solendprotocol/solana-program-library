...
use solend_program::{
    ...
    state::{FeeCalculation, LendingMarket, Obligation, Reserve, INITIAL_COLLATERAL_RATIO},
};
...
async fn setup() -> (
    ...
    let (mut test, lending_market, usdc_reserve, wsol_reserve, _, user) = setup_world().await;
